...
const s = {
  ...
  statusBadge: { padding:"4px 10px", borderRadius:"100px",
    fontSize:"12px", fontWeight:"600" },
  cardBody: { display:"flex", gap:"24px", flexWrap:"wrap",
    padding:"12px 0", borderTop:"1px solid #F0EDE8",
    borderBottom:"1px solid #F0EDE8", marginBottom:"12px" },
  infoItem: { display:"flex", flexDirection:"column", gap:"2px" },
  infoLabel: { fontSize:"11px", fontWeight:"600", color:"#A09D97",
    textTransform:"uppercase" },
  infoVal: { fontSize:"13px", fontWeight:"500", color:"#1C1B18" },
  reason: { fontSize:"13px", color:"#7A7870", fontStyle:"italic",
    marginBottom:"12px" },
  actions: { display:"flex", justifyContent:"flex-end", gap:"8px" },
  rejectBtn: { background:"#FEF2F2", border:"1px solid #FECACA",
    borderRadius:"9px", padding:"8px 16px", fontSize:"13px",
    fontWeight:"600", color:"#991B1B", cursor:"pointer" },
  approveBtn: { background:"#1C1B18", border:"none", borderRadius:"9px",
