      ...
      <div style={{ animation: "pageIn 0.4s ease both" }}>
        ...
        {loading ? (
          ...
          <div style={{ background: "#FFFFFF", border: "1px solid #E2E8F0", borderRadius: "16px", padding: "60px", textAlign: "center", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
            <div style={{ marginBottom: "12px", display: "flex", justifyContent: "center" }}><RefreshCw size={36} color="#94A3B8" /></div>
                ...
                <div key={r.swap_id}
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
                    <span style={{ padding: "5px 12px", borderRadius: "100px", fontSize: "12px", fontWeight: "700", background: typeColor.bg, color: typeColor.color }}>
                      {r.request_type === "swap" ? (
                        <span style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}><RefreshCw size={12} /> Shift Swap</span>
                      ) : (
                        <span style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}><AlertOctagon size={12} /> Replacement</span>
                      )}
                    </span>
