...
export default function BOReportHistory() {
  const goTo = useGoTo();
  ...
  return (
    <BusinessOwnerLayout title="Report History">
      <div style={{ animation: "pageIn 0.4s ease both" }}>

        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px" }}>
          <button onClick={() => goTo("/business-owner/reports")}
          ...
          <div>
            ...
            <p style={{ fontSize: "13px", color: "#64748B", marginTop: "2px" }}>All reports you have exported</p>
          </div>
        </div>
