              ...
              {weeklyAI.step === "generating" && (
                <div style={{ display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"80px 20px",gap:"20px" }}>
                  ...
                  <div style={{ textAlign:"center" }}>
                    ...
                    <p style={{ fontSize:"13px",color:"#64748B",lineHeight:1.65,maxWidth:"300px" }}>Analysing staff availability, branch hours, and role templates to craft your schedule.</p>
                  </div>
