...
const NAV = [
  { label: "Dashboard",    path: "/system-admin/dashboard",  icon: "⊞" },
  { label: "Businesses",   path: "/system-admin/businesses", icon: "🏢" },
  { label: "Managers",     path: "/system-admin/managers",   icon: "👔" },
  { label: "Skill Tags",   path: "/system-admin/skills",     icon: "🏷" },
  { label: "Krewby Workers", path: "/system-admin/krewby-workers", icon: "🤝" },
];
...
const s = {
  ...
  adminBadge: { display:"inline-block", background:"#3B82F6", color:"#FFFFFF",
  ...
  navItemActive: { background:"rgba(59,130,246,0.2)", color:"#93C5FD" },
