...
const NAV = [
  { label: "Dashboard",     path: "/regular-staff/dashboard",     icon: "⊞" },
  { label: "My Shifts",     path: "/regular-staff/shifts",        icon: "📅" },
  { label: "Leave",         path: "/regular-staff/leave",         icon: "🏖" },
  { label: "Swap Requests", path: "/regular-staff/swaps",         icon: "🔄" },
  { label: "Notifications", path: "/regular-staff/notifications", icon: "🔔" },
];
    ...
    <div style={s.shell}>
      <aside style={{ ...s.sidebar, ...(open ? s.sidebarOpen : {}) }}>
        ...
        <div style={s.sidebarBottom}>
          <div style={s.userRow}>
            <div style={s.avatar}>{user?.full_name?.[0]?.toUpperCase() || "S"}</div>
...
const s = {
  ...
  sidebar: { width:"220px", minHeight:"100vh", background:"#0F172A",
