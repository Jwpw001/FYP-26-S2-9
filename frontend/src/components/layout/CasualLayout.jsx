...
const s = {
  ...
  topbar:  { height: "calc(60px + env(safe-area-inset-top))", background: "#FFF", borderBottom: "1px solid #E2E8F0", display: "flex", alignItems: "center", padding: "0 28px", gap: "16px", position: "sticky", top: 0, zIndex: 100, paddingTop: "calc(0px + env(safe-area-inset-top))" },
