...
const NAV = [
  { label: "Dashboard",    path: "/krewby-worker/dashboard",    icon: "⊞" },
  { label: "My Jobs",      path: "/krewby-worker/jobs",         icon: "💼" },
  { label: "Availability", path: "/krewby-worker/availability", icon: "🗓" },
  { label: "Notifications",path: "/krewby-worker/notifications",icon: "🔔" },
];
    ...
    <div style={s.shell}>
      <aside style={{ ...s.sidebar, ...(open ? s.sidebarOpen : {}) }}>
        ...
        <div style={s.sidebarBottom}>
          <div style={s.userRow}>
            <div style={s.avatar}>{user?.full_name?.[0]?.toUpperCase() || "W"}</div>
...
const s = {
  ...
  logoRow: { display: "flex", alignItems: "center", gap: "10px", textDecoration: "none", marginBottom: "10px" },
  logoBox: {
