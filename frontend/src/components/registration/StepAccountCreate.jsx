...
export default function StepAccountCreate({ form, set, error, onNext, onBack }) {
  ...
  return (
    <>
      ...
      <h2 style={{ fontSize: "25px", fontWeight: "800", color: "#0F172A", marginBottom: "6px" }}>Your account</h2>
      <p style={{ fontSize: "21px", color: "#64748B", marginBottom: "28px" }}>Create your Business Owner login credentials.</p>
