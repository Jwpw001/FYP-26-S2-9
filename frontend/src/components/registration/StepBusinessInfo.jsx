...
export default function StepBusinessInfo({ form, set, error, onNext, onBack }) {
  ...
  return (
    <>
      ...
      <h2 style={{ fontSize: "22px", fontWeight: "800", color: "#0F172A", marginBottom: "6px" }}>Create a business</h2>
      <p style={{ fontSize: "14px", color: "#64748B", marginBottom: "28px" }}>Tell us about your business so we can set things up.</p>
