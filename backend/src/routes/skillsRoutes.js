...
const { getStaffSkills, addStaffSkill, updateStaffSkill, removeStaffSkill, getOutletStaffSkills, getGlobalSkills } = require("../controllers/skillsController");

const CAN_READ  = [ROLES.BUSINESS_OWNER, ROLES.OUTLET_MANAGER, ROLES.SYSTEM_ADMIN];
const CAN_WRITE = [ROLES.OUTLET_MANAGER, ROLES.SYSTEM_ADMIN];
...
router.get("/outlet/:outlet_id",            verifyToken, allowRoles(...CAN_READ),  getOutletStaffSkills);
