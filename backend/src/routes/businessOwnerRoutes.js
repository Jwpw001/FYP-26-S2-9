...
router.get("/branches/:branch_id/skill-suggestions",   OWNER_OR_MGR, getBranchSkillSuggestions);
...
router.post("/branches/:branch_id/closures",            OWNER_OR_MGR, markDateClosed);
