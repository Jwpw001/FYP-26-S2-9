// Casual staff MyShifts — same logic as regular staff
    ...
    <SafeAreaView style={s.safe} edges={["top"]}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<View style={s.empty}><Text style={s.emptyIcon}>📅</Text><Text style={s.emptyText}>No {filter} shifts</Text></View>}
        />
      )}
    </SafeAreaView>
  );
